<x-layout.default>
        ...
        <div class="pt-5 space-y-8">
            <div class="panel">
                <div class="flex items-center justify-between mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">Standard Operational Procedure</h5>
                    <button id="createBtn" class="btn btn-primary">Create</button>
                    <button id="backBtn" class="btn btn-primary" style="display: none">Back</button>
                </div>
                <div class="mb-5" x-data="{ active: 1 }" id="table_sop">
                    <div class="space-y-2 font-semibold">
                        <table class="min-w-full table" id="table_sop_table">
                            <thead
                ...
                <div class="mb-5" x-data="{ active: 1 }" id="form_create" style="display: none">
                    <div class="space-y-2 font-semibold">
                            ...
                            <div x-cloak x-show="active === 1" x-collapse>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 dark:text-white-light">
                                    <div>
                                        ...
                                        <select class="form-select text-black dark:text-white" id="partNum">
                                        </select>
                                    </div>
                                    <div>
    ...
    <script>
        ...
        function tableFunc() {
            table = $("#table_sop_table").DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ url('api/menu_sop/show') }}",
                    type: 'POST',
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        $("#btn_submit").on('click', function() {
            ...
            if (!part_num || !title || !step || !description) {
                new window.Swal({
                    icon: 'error',
        ...
        function ViewBtn(dtl) {
            window.location.href = "{{ url('standard_operational_procedure') }}/" + dtl
        }
    </script>
</x-layout.default>
