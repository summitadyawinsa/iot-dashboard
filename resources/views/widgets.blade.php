                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <span
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="https://www.w3.org/2000/svg" class="h-6 w-6">
                                    <path
            ...
            <div class="panel h-full">
                ...
                <div class="group">
                    ...
                    <div class="flex items-center justify-between mb-2 font-semibold">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="https://www.w3.org/2000/svg" class="w-4 h-4 text-success">
                                <path opacity="0.5"
                    ...
                    <div class="flex items-end justify-between">
                        <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="https://www.w3.org/2000/svg" class="w-3 h-3 ltr:mr-1 rtl:ml-1">
                                <circle opacity="0.5" cx="12" cy="12" r="10"
                                    stroke="currentColor" stroke-width="1.5" />
            ...
            Alpine.data("chart", () => ({
                ...
                init() {
                    ...
                    setTimeout(() => {
                        ...
                        // daily sales
                        this.dailySales = new ApexCharts(this.$refs.dailySales,
                        ...
                        //total visit
                        this.totalVisit = new ApexCharts(this.$refs.totalVisit,
                            this.totalVisitOptions);
                        this.totalVisit.render();

                        this.paidVisit = new ApexCharts(this.$refs.paidVisit,
                            this.paidVisitOptions);
