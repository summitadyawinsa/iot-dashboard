                ...
                <div class="panel">
                    ...
                    <div class="swiper max-w-3xl mx-auto mb-5" id="slider1">
                        ...
                        <a href="javascript:;"
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="https://www.w3.org/2000/svg" class="w-5 h-5 rtl:rotate-180">
                        ...
                        <a href="javascript:;"
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="https://www.w3.org/2000/svg" class="w-5 h-5 ltr:rotate-180">
                                <path d="M15 5L9 12L15 19" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                ...
                <div class="panel">
                    ...
                    <div class="swiper max-w-3xl mx-auto mb-5" id="slider3">
                        <div class="swiper-wrapper">
                            <template x-for="item in items">
                                <div class="swiper-slide">
                                    <img :src="`/assets/images/${item}`" class="w-full"
                                        alt="image" />
                                    <div
