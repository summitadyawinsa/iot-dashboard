                ...
                <div class="mb-5">
                    <div class="flex flex-wrap items-center justify-center gap-2">
                        <button type="button" class="btn btn-primary">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="https://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-1.5 rtl:ml-1.5 shrink-0">
                        ...
                        <button type="button" class="btn btn-warning rounded-full">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="https://www.w3.org/2000/svg" class="w-5 h-5 ltr:ml-1.5 rtl:mr-1.5 shrink-0">
                                <path
