<x-layout.default>
    ...
    <style>
        ...
        #profitability_by_year_table tbody tr:hover,
        #profitability_by_month_table tbody tr:hover,
        #profitability_cust_by_month_table tbody tr:hover,
        #sales-expenses-table tbody tr:hover,
        #profitability_cust_by_year_table tbody tr:hover,
        #profitability_model_year_table tbody tr:hover,
        #profitability_category_month_table tbody:hover,
        #profitability_category_year_table tbody tr:hover,
        #profitability_model_month_table tbody tr:hover {
            background-color: #727e93;
            cursor: pointer;
        }

        #sales-cost-table tbody tr,
        #sales-expenses-table tbody tr,
        #profitability_model_year_table tbody tr,
        #profitability_by_month_table tbody tr,
        #profitability_category_month_table tbody tr,
        #profitability_cust_by_month_table tbody tr,
        #profitability_by_year_table tbody tr,
        #profitability_cust_by_year_table tbody tr,
        #profitability_category_year_table tbody tr,
        #profitability_model_month_table tbody tr {
        ...
        #sales-expenses-table thead tr,
        #profitability_model_year_table thead tr,
        #profitability_by_month_table thead tr,
        #profitability_cust_by_month_table thead tr,
        #profitability_category_month_table thead tr,
        #profitability_cust_by_year_table thead tr,
        #profitability_by_year_table thead tr,
        #profitability_category_year_table thead tr,
        #profitability_model_month_table thead tr {
            color: whitesmoke;
        }

        #current_month_customer::-webkit-calendar-picker-indicator,
        #month_year_table::-webkit-calendar-picker-indicator,
        #expenses_month_teble::-webkit-calendar-picker-indicator,
        ...
        select[name="profitability_model_year_table_length"],
        select[name="profitability_by_month_table_length"],
        select[name="sales-expenses-table_length"],
        select[name="profitability_category_year_table_length"],
        select[name="profitability_category_month_table_length"],
        select[name="profitability_cust_by_month_table_length"],
        select[name="profitability_by_year_table_length"],
        select[name="profitability_cust_by_year_table_length"],
        select[name="profitability_model_month_table_length"] {
            background-color: #4B5563;
            width: 80px;
        }
    </style>
        ...
        <div class="pt-5">
            <div class="grid sm:grid-cols-2 xl:grid-cols-12 gap-6 mb-6">
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-6">
                    <label for="selectYearly" class="text-xl font-bold">Profitability By Years</label>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 dark:text-white-light">
                        <div>
                            <label for="production_date">Start</label>
                            <input id="start_year" type="number" class="form-input"
                                value="<?= $startYear ?>"style="color: white;" />
                        </div>
                        <div>
                            <label for="standard_sph">End</label>
                            <input id="end_year" type="number" class="form-input"
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_chart"
                                x-on:click="() => ChartRecall1(inpt_val_data_year.value, inpt_val_profit_chart.value, inpt_val_loss_chart.value)"
                            ...
                            <input type="text" id="inpt_val_loss_chart" value="" hidden>
                            <div x-ref="BoxChart1" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_by_year_table" class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal" style="font-size: 0.9674rem;">
                                    ...
                                    <th class="py-3 px-6 text-left">Loss</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-6">
                    <label for="current_year" class="text-xl font-bold">Profitability By Months</label>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 dark:text-white-light">
                        <div>
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_chart_month"
                                x-on:click="() => ChartRecall2(inpt_val_month_chart_month.value, inpt_val_profit_chart_month.value, inpt_val_loss_chart_month.value)"
                                hidden>Recall and Update</button>
                            <input type="text" id="inpt_val_month_chart_month" value="" hidden>
                            <input type="text" id="inpt_val_profit_chart_month" value="" hidden>
                            <input type="text" id="inpt_val_loss_chart_month" value="" hidden>
                            <div x-ref="BoxChart2" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_by_month_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal" style="font-size: 0.9674rem;">
                                    <th class="py-3 px-6 text-left">Year</th>
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-6">
                    <label for="current_year_customer" class="text-xl font-bold">Profitability Per Customers By
                        Years</label>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 dark:text-white-light">
                        <div>
                            <label for="current_year_customer">Year</label>
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_cust_year"
                                x-on:click="() => ChartRecall3(inpt_val_data_years.value, inpt_val_profit_cust_year.value, inpt_val_loss_cust_year.value)"
                                hidden>Recall and Update</button>
                            <input type="text" id="inpt_val_data_years" value="" hidden>
                            <input type="text" id="inpt_val_profit_cust_year" value="" hidden>
                            <input type="text" id="inpt_val_loss_cust_year" value="" hidden>
                            <div x-ref="BoxChart3" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_cust_by_year_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal"
                                    style="font-size: 0.9674rem;">
                                    <th class="py-3 px-6 text-left">Year</th>
                                    <th class="py-3 px-6 text-left">Cust</th>
                                    <th class="py-3 px-6 text-left">Profit</th>
                                    <th class="py-3 px-6 text-left">Loss</th>
                                </tr>
                            </thead>
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-6">
                    <label for="current_month_customer" class="text-xl font-bold">Profitability Per Customers By
                        Months</label>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 dark:text-white-light">
                        <div>
                            <label for="current_month_customer">Month</label>
                            <input id="current_month_customer" type="month" class="form-input"
                                value="<?= $lastMonth ?>" style="color: white;" />
                        </div>
                    </div>
                    <hr>
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_cust_month"
                                x-on:click="() => ChartRecall4(inpt_val_data_cust.value, inpt_val_profit_cust_month.value, inpt_val_loss_cust_month.value)"
                                hidden>Recall and Update</button>
                            <input type="text" id="inpt_val_data_cust" value="" hidden>
                            <input type="text" id="inpt_val_profit_cust_month" value="" hidden>
                            <input type="text" id="inpt_val_loss_cust_month" value="" hidden>
                            <div x-ref="BoxChart4" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_cust_by_month_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal"
                                    style="font-size: 0.9674rem;">
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-6">
                    <div class="grid grid-cols-1 gap-4 p-5 dark:text-white-light">
                        <div class="grid grid-cols-3">
                            <label for="selectYearly" class="text-xl font-bold">Profitability By Model Year</label>
                            <span></span>
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_chart_model"
                                x-on:click="() => ChartRecall12(inpt_data_profit.value, inpt_data_loss.value, inpt_data_model.value)"
                                hidden>Recall and Update
                            </button>
                            <input type="text" id="inpt_data_profit" value="" hidden>
                            <input type="text" id="inpt_data_loss" value="" hidden>
                            <input type="text" id="inpt_data_model" value="" hidden>
                            <div x-ref="BoxChart13" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_model_year_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal"
                                    style="font-size: 0.9674rem;">
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-6">
                    <div class="grid grid-cols-1 gap-4 p-5 dark:text-white-light">
                        <div class="grid grid-cols-3">
                            <label for="selectMonthly" class="text-xl font-bold">Profitability By Model Month</label>
                            <span></span>
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_month"
                                x-on:click="() => ChartRecall13(inpt_data_profit_month.value, inpt_data_loss_month.value, inpt_data_model_month.value)"
                                hidden>Recall and Update
                            </button>
                            <input type="text" id="inpt_data_profit_month" value="" hidden>
                            <input type="text" id="inpt_data_loss_month" value="" hidden>
                            <input type="text" id="inpt_data_model_month" value="" hidden>
                            <div x-ref="BoxChart14" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_model_month_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal"
                                    style="font-size: 0.9674rem;">
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_category"
                                x-on:click="() => ChartRecall14(inpt_data_profit_category.value, inpt_data_loss_category.value, inpt_data_category.value)"
                                hidden>Recall and Update
                            </button>
                            <input type="text" id="inpt_data_profit_category" value="" hidden>
                            <input type="text" id="inpt_data_loss_category" value="" hidden>
                            <input type="text" id="inpt_data_category" value="" hidden>
                            <div x-ref="BoxChart15" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_category_year_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal"
                                    style="font-size: 0.9674rem;">
                    ...
                    <div>
                        <div class="h-full sm:col-span-6 xl:col-span-2">
                            <button id="btn_update_category_month"
                                x-on:click="() => ChartRecall15(inpt_data_profit_category_month.value, inpt_data_loss_category_month.value, inpt_data_category_month.value)"
                                hidden>Recall and Update
                            </button>
                            <input type="text" id="inpt_data_profit_category_month" value="" hidden>
                            <input type="text" id="inpt_data_loss_category_month" value="" hidden>
                            <input type="text" id="inpt_data_category_month" value="" hidden>
                            <div x-ref="BoxChart16" class="overflow-hidden"></div>
                        </div>
                    </div>
                    <div class="relative overflow-hidden pt-5">
                        <table id="profitability_category_month_table"
                            class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-white text-sm leading-normal"
                                    style="font-size: 0.9674rem;">
                ...
                <div class="panel h-full col-span-6">
                    <div class="grid grid-cols-1 gap-4 p-5 dark:text-white-light">
                        <div class="grid grid-cols-3">
                            <label for="month_year_table" class="text-xl font-bold">Part Monthly Month</label>
                            <span></span>
                ...
                <div class="panel h-full col-span-6">
                    <div class="grid grid-cols-1 gap-4 p-5 dark:text-white-light">
                        <div class="grid grid-cols-3">
                            <label for="expenses_month_teble" class="text-xl font-bold">Part Monthly Month</label>
                            <span></span>
                            <input id="expenses_month_teble" type="month" class="form-input"
                                value="<?= $lastMonth ?>" style="color: white;" />
                        </div>
                    </div>
                    <hr>
                    <div class="relative overflow-hidden pt-5">
                        <table id="sales-expenses-table" class="min-w-full rounded-md shadow-md overflow-hidden">
                            <thead>
                                <tr class="bg-gray-600 text-gray-600 text-sm leading-normal"
                                    style="font-size: 0.9674rem; color: whitesmoke;">
                                    <th class="py-3 px-6 text-left">Years</th>
                                    ...
                                    <th class="py-3 px-6 text-left">Sales</th>
                                    <th class="py-3 px-6 text-left">Expenses</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
            ...
            <div id="detail_modal"
                ...
                <div class="panel rounded-lg shadow-xl w-full max-w-7xl max-h-[90vh] flex flex-col">
                    ...
                    <div class="flex justify-between items-center p-4 border-b border-gray-600">
                        <div>
                            ...
                            <span id="date-title" class="text-gray-300 text-md mt-1"></span>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (!response.data || response.data.length === 0) {
                                    document.getElementById('modal-body-content').innerHTML =
                                        `<div class="text-gray-400 text-center py-8">No data available.</div>`;
                                    return;
                                }
                                ...
                                let cardsHTML = `<div class="p-4 text-white">`;

                                cardsHTML += `
                                        <h3 class="text-lg font-semibold text-gray-300 mb-4">Direct Costs & COGM</h3>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">L</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.LaborCost)}</p>
                                                    <h5 class="text-gray-400 text-md">Labor Cost</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">B</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.BurdenCost)}</p>
                                                    <h5 class="text-gray-400 text-md">Burden Cost</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">M</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.MtlUnitCost)}</p>
                                                    <h5 class="text-gray-400 text-md">Material Unit Cost</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">BM</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.BurMtlUniCost)}</p>
                                                    <h5 class="text-gray-400 text-md">Burden Material Cost</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">S</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.SbcCost)}</p>
                                                    <h5 class="text-gray-400 text-md">SBC Cost</h5>
                                                </div>
                                            </div>
                                        </div>
                                    `;
                                ...
                                cardsHTML += `
                                        <h3 class="text-lg font-semibold text-gray-300 mb-4">Variances</h3>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">VL</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.VarianceAplLabor)}</p>
                                                    <h5 class="text-gray-400 text-md">Variance Apl Labor</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">VM</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.VarianceAplMaterial)}</p>
                                                    <h5 class="text-gray-400 text-md">Variance Apl Material</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">VB</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.VarianceAplBurden)}</p>
                                                    <h5 class="text-gray-400 text-md">Variance Apl Burden</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">VMB</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.VarianceMtlBurden)}</p>
                                                    <h5 class="text-gray-400 text-md">Variance Mtl Burden</h5>
                                                </div>
                                            </div>
                                            <div class="bg-gray-700 p-4 rounded-lg flex items-center">
                                                <div class="shrink-0 bg-gray-800 border border-gray-600 text-gray-300 rounded-xl w-14 h-14 flex justify-center items-center font-bold text-xl">VSC</div>
                                                <div class="ltr:ml-4 rtl:mr-4">
                                                    <p class="text-lg font-bold">${formatNumber(totals.VarianceSubCont)}</p>
                                                    <h5 class="text-gray-400 text-md">Variance Sub Cont</h5>
                                                </div>
                                            </div>
                                        </div>
                                    `;
            ...
            function detail_table_expenses() {
                detailTableExpensesByMonth = $("#sales-expenses-table").DataTable({
                    destroy: true,
                    scrollX: true,
                    processing: true,
                    serverSide: true,
                    ...
                    ajax: {
                        url: `https://${window.location.host}/api/finance/get_invoice_expenses_table`,
                        type: 'POST',
                        data: function(d) {
                            d.year = document.getElementById('expenses_month_teble').value;
                        },
                        cache: false,
                        dataType: 'json'
                    },
                ...
                buttonContainer.style.gap = '10px';
                buttonContainer.style.marginTop = '10px';
                buttonContainer.id = 'sales-expenses-table_button_container';

                const downloadButton = document.createElement('button');
                downloadButton.id = 'download_sales-expenses-table_button';
                downloadButton.className = 'btn btn-primary';
                downloadButton.innerHTML = `
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                        <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
                ...
                const tableWrapper = document.querySelector('#sales-expenses-table_wrapper');
                if (tableWrapper) {
                    const existingContainer = document.getElementById('sales-expenses-table_button_container');
                    if (existingContainer) existingContainer.remove();
                    tableWrapper.insertAdjacentElement('afterend', buttonContainer);
                } else {
                    console.error('Table wrapper #sales-expenses-table_wrapper not found');
                }
                ...
                setTimeout(function() {
                    detailTableExpensesByMonth.ajax.reload();
                }, 100);

                return detailTableExpensesByMonth;
            }

            function setDefaultData() {
                var currentHost = window.location.host;
                var yearX = document.getElementById('start_year').value;
                var yearY = document.getElementById('end_year').value;
                const apiUrl = `https://${currentHost}/api/finance/get_profitability_yearly/${yearX}-${yearY}`;

                axios.get(apiUrl)
                    .then(response => {
                        var data_year = response.data.data_year;
                        var data_chart_profit = response.data.data_chart_profit;
                        var data_chart_loss = response.data.data_chart_loss;
                        ...
                        document.getElementById('inpt_val_loss_chart').value = data_chart_loss;
                ...
                const apiUrlMonth = `https://${currentHost}/api/finance/get_profitability_monthly/${monthX}`;
                axios.get(apiUrlMonth)
                    .then(response => {
                        var data_months = response.data.data_months;
                        var data_chart_profit = response.data.data_chart_profit;
                        var data_chart_loss = response.data.data_chart_loss;
                        document.getElementById('inpt_val_month_chart_month').value = data_months;
                        document.getElementById('inpt_val_profit_chart_month').value = data_chart_profit;
                        document.getElementById('inpt_val_loss_chart_month').value = data_chart_loss;
                ...
                const apiUrlCust =
                    `https://${currentHost}/api/finance/get_profitability_invoice_cust_yearly/${year_cust}`;
                axios.get(apiUrlCust)
                    .then(response => {
                        var data_year = response.data.data_year;
                        var data_cust_profit_year = response.data.data_cust_profit_year;
                        var data_cust_loss_year = response.data.data_cust_loss_year;
                        document.getElementById('inpt_val_data_years').value = data_year;
                        document.getElementById('inpt_val_profit_cust_year').value = data_cust_profit_year;
                        document.getElementById('inpt_val_loss_cust_year').value = data_cust_loss_year;
                ...
                const apiUrlCustMonth =
                    `https://${currentHost}/api/finance/get_profitability_invoice_cust_monthly/${month_cust}`;
                axios.get(apiUrlCustMonth)
                    .then(response => {
                        ...
                        var data_cust_loss_month = response.data.data_cust_loss_month;
                        ...
                        document.getElementById('inpt_val_loss_cust_month').value = data_cust_loss_month;
            ...
            document.getElementById('current_year').addEventListener('change', function() {
                ...
                const apiUrlMonth = `https://${currentHost}/api/finance/get_profitability_monthly/${year}`;
                axios.get(apiUrlMonth)
                    .then(response => {
                        ...
                        var data_chart_profit = response.data.data_chart_profit;
                        var data_chart_loss = response.data.data_chart_loss;
                        document.getElementById('inpt_val_month_chart_month').value =
                            data_months;
                        document.getElementById('inpt_val_profit_chart_month').value =
                            data_chart_profit;
                        document.getElementById('inpt_val_loss_chart_month').value =
                            data_chart_loss;
                        document.getElementById('btn_update_chart_month').click();
                    })
                    .catch(error => {
            ...
            document.getElementById('current_month_customer').addEventListener('change', function() {
                ...
                axios.get(apiUrlCustMonth)
                    .then(response => {
                        ...
                        document.getElementById('inpt_val_loss_cust_month').value =
        ...
        function updateChartYear() {
            ...
            const apiUrlYearly = `https://${currentHost}/api/finance/get_profitability_model_yearly/${selectYearly}`;
            axios.get(apiUrlYearly)
                .then(response => {
                    ...
                    document.getElementById('inpt_data_loss').value = data_chart_loss;
        ...
        function updateChartMonth() {
            ...
            const apiUrlMonthly = `https://${currentHost}/api/finance/get_profitability_model_monthly/${selectMonthly}`;
            axios.get(apiUrlMonthly)
                .then(response => {
                    ...
                    document.getElementById('inpt_data_loss_month').value = data_chart_loss;
        ...
        function updateChartYearCat() {
            ...
            const apiUrlCatYear = `https://${currentHost}/api/finance/get_profitability_category_year/${selectCatYear}`;
            axios.get(apiUrlCatYear)
                .then(response => {
                    ...
                    document.getElementById('inpt_data_loss_category').value = data_chart_loss;
        ...
        function updateChartMonthCat() {
            ...
            const apiUrlCatMonth = `https://${currentHost}/api/finance/get_profitability_category_month/${selectCatMonth}`;
            axios.get(apiUrlCatMonth)
                .then(response => {
                    var data_chart_profit_month = response.data.data_chart_profit_month;
                    var data_chart_loss_month = response.data.data_chart_loss_month;
                    ...
                    document.getElementById('inpt_data_loss_category_month').value = data_chart_loss_month;
        ...
        document.addEventListener("alpine:init", () => {
            Alpine.data("analytics", () => ({
                ...
                ChartRecall1(dataYear, profitData, lossData) {
                    const year = dataYear.split(',').map(Number);
                    const profit = profitData.split(',').map(Number);
                    const loss = lossData.split(',').map(Number);
                        ...
                        chart: {
                            events: {
                                click: function(event, chartContext, config) {
                                    ...
                                    const apiUrlMonth =
                                        `https://${currentHost}/api/finance/get_profitability_monthly/${value}`;
                                    axios.get(apiUrlMonth)
                                        .then(response => {
                                            var data_months = response.data
                                                .data_months;
                                            var data_chart_profit = response.data
                                                .data_chart_profit;
                                            var data_chart_loss = response.data
                                                .data_chart_loss;
                                            document.getElementById(
                                                    'inpt_val_month_chart_month')
                                                .value = data_months;
                                            document.getElementById(
                                                    'inpt_val_profit_chart_month')
                                                .value = data_chart_profit;
                                            document.getElementById(
                                                    'inpt_val_loss_chart_month').value =
                                                data_chart_loss;
                                            document.getElementById(
                                    ...
                                    const apiUrlCust =
                                        `https://${currentHost}/api/finance/get_profitability_invoice_cust_yearly/${value}`;
                                    axios.get(apiUrlCust)
                                        .then(response => {
                                            var data_year = response.data.data_year;
                                            var data_cust_profit_year = response.data
                                                .data_cust_profit_year;
                                            var data_cust_loss_year = response.data
                                                .data_cust_loss_year;
                                            document.getElementById(
                                                    'inpt_val_data_years').value =
                                                data_year;
                                            document.getElementById(
                                                    'inpt_val_profit_cust_year').value =
                                                data_cust_profit_year;
                                            document.getElementById(
                                                    'inpt_val_loss_cust_year').value =
                                                argumentsdata_cust_loss_year;
                                            document.getElementById(
                ...
                ChartRecall2(dataMonth, profitData, lossData) {
                        ...
                        chart: {
                            events: {
                                click: function(event, chartContext, config) {
                                    ...
                                    const apiUrlCustMonth =
                                        `https://${currentHost}/api/finance/get_profitability_invoice_cust_monthly/${postValue}`;
                                    axios.get(apiUrlCustMonth)
                                        .then(response => {
                                            var data_cust = response.data.data_cust;
                                            var data_cust_profit_month = response.data
                                                .data_cust_profit_month;
                                            var data_cust_loss_month = response.data
                                                .data_cust_loss_month;
                                            document.getElementById(
                                            ...
                                            document.getElementById(
                                                ...
                                                data_cust_profit_month;
                                            document.getElementById(
                                                    'inpt_val_loss_cust_month').value =
                                                data_cust_loss_month;
                                            document.getElementById(
                ...
                ChartRecall3(dataCust, profitData, lossData) {
                ...
                ChartRecall4(dataCust, salesData, costData) {
                    const cust = dataCust.split(',');
                    const profit = salesData.split(',').map(Number);
                    const loss = costData.split(',').map(Number);
                ...
                ChartRecall12(dataProfit, dataLoss, dataModel) {
                    const profit = dataProfit.split(',').map(Number);
                    const loss = dataLoss.split(',').map(Number);
                ...
                ChartRecall13(dataProfit, dataLoss, dataModel) {
                    const profit = dataProfit.split(',').map(Number);
                    const loss = dataLoss.split(',').map(Number);
                    const model = dataModel.split(',');
                ...
                ChartRecall14(dataProfit, dataLoss, dataCategory) {
                    const profit = dataProfit.split(',').map(Number);
                    const loss = dataLoss.split(',').map(Number);
                ...
                ChartRecall15(dataProfit, dataLoss, dataCategory) {
                    const profit = dataProfit.split(',').map(Number);
                    const loss = dataLoss.split(',').map(Number);
                    const category = dataCategory.split(',');
                ...
                get BoxChart1Options() {
                    return {
                        ...
                        yaxis: {
                            ...
                            min: undefined, // biar auto, bisa juga set manual misal min: -1000
                            forceNiceScale: true,
                            axisBorder: {
                                show: true,
                                color: '#3b3f5c'
                ...
                get BoxChart2Options() {
                    return {
                        ...
                        stroke: {
                            width: [3, 0],
                            colors: ['#2196f3', '#f44336'] // Warna Sales (biru) & Cost (merah)
                        },
                        colors: ['#2196f3', '#f44336'],
                        dropShadow: {
                            enabled: true,
                ...
                get BoxChart5Options() {
                    return {
                        ...
                        xaxis: {
                            categories: [], // Kosongkan karena akan diisi secara dinamis
                            axisBorder: {
                                show: true,
                                color: '#3b3f5c'
                            },
        ...
        function detail_table_profit_model_yearly() {
            ...
            detailTableProfitYear = $("#profitability_model_year_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/get_profitability_model_by_yearly_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_model_year_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_model_year_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_model_year_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_model_year_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_model_year_table_wrapper not found');
            }
        ...
        function detail_table_profit_by_year() {
            ...
            detailTableProfitByYears = $("#profitability_by_year_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/get_profitability_by_year_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({});
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_by_year_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_by_year_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_by_year_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_by_year_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_by_year_table_wrapper not found');
            }
        ...
        function detail_table_profit_by_month() {
            ...
            detailTableProfitByMonths = $("#profitability_by_month_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/get_profitability_by_month_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_by_month_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_by_month_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_by_month_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_by_month_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_by_month_table_wrapper not found');
            }
        ...
        function detail_table_profi_cust_by_year() {
            ...
            detailTableProfitCustByYear = $("#profitability_cust_by_year_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/profitability_invoice_cust_yearly_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_cust_by_year_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_cust_by_year_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_cust_by_year_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_cust_by_year_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_cust_by_year_table_wrapper not found');
            }
        ...
        function detail_table_profi_cust_by_month() {
            ...
            detailTableProfitCustByMonth = $("#profitability_cust_by_month_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/profitability_invoice_cust_month_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_cust_by_month_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_cust_by_month_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_cust_by_month_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_cust_by_month_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_cust_by_month_table_wrapper not found');
            }
        ...
        function detail_table_profit_category_yearly() {
            ...
            detailTableCategoryProfitYear = $("#profitability_category_year_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/get_profitability_category_by_yearly_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_category_year_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'downloabilityad_profit_category_year_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_category_year_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_category_year_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_category_year_table_wrapper not found');
            }
        ...
        function detail_table_profit_category_monthly() {
            ...
            detailTableCategoryProfitMonth = $("#profitability_category_month_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/get_profitability_category_by_month_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_category_month_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_category_month_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_category_month_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_category_month_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_category_month_table_wrapper not found');
            }
        ...
        function detail_table_profit_model_monthly() {
            ...
            detailTableProfitMonth = $("#profitability_model_month_table").DataTable({
                destroy: true,
                scrollX: true,
                processing: true,
                serverSide: true,
                ...
                ajax: {
                    url: `https://${window.location.host}/api/finance/get_profitability_model_by_monthly_table`,
                    type: 'POST',
                    contentType: "application/json",
                    data: function(d) {
                        return JSON.stringify({
            ...
            buttonContainer.style.gap = '10px';
            buttonContainer.style.marginTop = '10px';
            buttonContainer.id = 'profitability_model_month_table_button_container';

            const downloadButton = document.createElement('button');
            downloadButton.id = 'download_profitability_model_month_table_button';
            downloadButton.className = 'btn btn-primary';
            downloadButton.innerHTML = `
            <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16" style="margin-right: 8px;">
                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1m-1 4v3.793l1.146-1.147a.5.5 0 0 1 .708.708l-2 2a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 .708-.708L7.5 11.293V7.5a.5.5 0 0 1 1 0"/>
        ...
        `;
            ...
            const tableWrapper = document.querySelector('#profitability_model_month_table_wrapper');
            if (tableWrapper) {
                const existingContainer = document.getElementById('profitability_model_month_table_button_container');
                if (existingContainer) existingContainer.remove();
                tableWrapper.insertAdjacentElement('afterend', buttonContainer);
            } else {
                console.error('Table wrapper #profitability_model_month_table_wrapper not found');
            }

            downloadButton.addEventListener('click', function() {
                createDateRangePopup('profitability_model_month_table');
            });
        ...
        `;
            ...
            document.getElementById('popupDownloadBtn').addEventListener('click', function() {
                ...
                if (tableType === 'profitability_model_month_table') {
                    downloadProfitModelMonthData(startDate, endDate);
                }
                overlay.remove();
            });
        }
    ...
    `;
            ...
            const apiUrl = `https://${window.location.host}/api/finance/get_profitability_by_year_table_export`;
            const postData = {
            ...
            axios.post(apiUrl, postData)
                .then(response => {
                    console.log('API Response (profitability_by_year_table):', response);
                    const tableData = response.data.data;

                    if (tableData && tableData.length > 0) {
                        const excelContent = convertToExcel(tableData);
                        const filename = `profitability_by_year_table.xlsx`;
                ...
                .catch(error => {
                    console.error('Error fetching data (profitability_by_year_table):', error);
        ...
        function downloadProfitMonthData() {
            ...
            const apiUrl = `https://${window.location.host}/api/finance/get_profitability_by_month_table_export`;
            const postData = {
                date: date
            };
            ...
            axios.post(apiUrl, postData)
                .then(response => {
                    console.log('API Response (profitability_by_month_table):', response);
                    const tableData = response.data.data;

                    if (tableData && tableData.length > 0) {
                        const excelContent = convertToExcel(tableData);
                        const filename = `profitability_by_month_table.xlsx`;
                        downloadExcel(excelContent, filename);
                    } else {
                        alert('No data available for the selected date.');
                    }
                ...
                .catch(error => {
                    console.error('Error fetching data (profitability_by_month_table):', error);
                    console.error('Error details:', error.response);
                    alert('Failed to fetch data for download.');
                })
                .finally(() => {
        ...
        `;
            ...
            axios.post(apiUrl, postData)
                .then(response => {
                    console.log('API Response (profitability_model_year_table):', response);
                    const tableData = response.data.data;
                    if (tableData && tableData.length > 0) {
                        const excelContent = convertToExcel(tableData);
                        const filename = `profitability_model_year_table_${date.replace(/\s+/g, '_')}.xlsx`;
                        downloadExcel(excelContent, filename);
                    } else {
                        alert('No data available for the selected date.');
                    }
                ...
                .catch(error => {
                    console.error('Error fetching data (profitability_model_year_table):', error);
                    console.error('Error details:', error.response);
                    alert('Failed to fetch data for download.');
                })
                .finally(() => {
        ...
        `;
            ...
            axios.post(apiUrl, postData)
                .then(response => {
                    console.log('API Response (profitability_cust_by_year_table):', response);
                    const tableData = response.data.data;
                    if (tableData && tableData.length > 0) {
                        const excelContent = convertToExcel(tableData);
                        const filename = `profitability_cust_by_year_table_${date.replace(/\s+/g, '_')}.xlsx`;
                        downloadExcel(excelContent, filename);
                    } else {
                        alert('No data available for the selected date.');
                    }
                ...
                .catch(error => {
                    console.error('Error fetching data (profitability_cust_by_year_table):', error);
                    console.error('Error details:', error.response);
                    alert('Failed to fetch data for download.');
                })
                .finally(() => {
        ...
        `;
            ...
            axios.post(apiUrl, postData)
                .then(response => {
                    console.log('API Response (profitability_category_year_table):', response);
                    const tableData = response.data.data;
                    if (tableData && tableData.length > 0) {
                        const excelContent = convertToExcel(tableData);
                        const filename = `profitability_category_year_table_${date.replace(/\s+/g, '_')}.xlsx`;
                        downloadExcel(excelContent, filename);
                    } else {
                        alert('No data available for the selected date.');
                    }
        ...
        document.getElementById('expenses_month_teble').addEventListener('change', function() {
            detail_table_expenses();
