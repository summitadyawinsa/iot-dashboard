<x-layout.default> 
    ...
    <div>
        ...
        <div class="pt-5">   
            <div class="grid sm:grid-cols-2 xl:grid-cols-8 gap-6 mb-6 flex flex-wrap justify-center"> 
            <?php 
                $bcolor_1 = 'primary' ; 
                $bcolor_2 = 'success' ; 
                $bcolor_3 = 'warning' ; 
                ...
                <div class="panel h-full sm:col-span-3 xl:col-span-2">
                    <div class="flex p-5 border-b  border-[#e0e6ed] dark:border-[#1b2e4b]">
                        <div class="shrink-0 bg-{{ ${'bcolor_'.$i} }}/10 text-danger rounded-xl w-11 h-11 flex justify-center items-center dark:bg-{{ ${'bcolor_'.$i} }} dark:text-white-light ">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="https://www.w3.org/2000/svg" class="group-hover:!text-{{ ${'bcolor_'.$i} }} shrink-0">
                    ...
                    <div class="flex items-center justify-center pt-3 gap-4 mb-3">  
                        <div class="text-center text-white-light z-[7] w-full">  
                            <div class="align-center xl:text-4xl sm:text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-2"> 
                                ...
                                <span  id="inpt_planning_stroke_{{ $row['mc_code'] }}">{{ number_format($row['plan'],0) }}</span>
                            </div>
                        </div>
                        <div class="text-center text-white-light z-[7]  w-full">  
                            <div class="align-center xl:text-4xl sm:text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-2"> 
                                ...
                                <span  id="inpt_actual_stroke_{{ $row['mc_code'] }}">{{ number_format($row['actual'],0) }}</span>
                            </div>
                        </div>  
                    </div>
                        ...
                        <div class="text-center text-white-light z-[7]">  
                            <div class="align-center text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-2">   
                                    <div class="w-full rounded-full h-5 p-1 bg-dark-light overflow-hidden shadow-3xl dark:shadow-none dark:bg-dark-light/10 xl:mb-5 xl:mt-5 sm:mb-4 sm:mt-5">
                                        <div id="bar_progress_{{ $row['mc_code'] }}" class="bg-gradient-to-r from-[#e7515a] to-[#00ab55] w-full h-full rounded-full relative before:absolute before:inset-y-0 ltr:before:right-0.5 rtl:before:left-0.5 before:bg-white before:w-2 before:h-2 before:rounded-full before:m-auto"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 pt-3 gap-3 mb-3">
                        <div class="text-center text-white-light z-[7]">  
                            <div class="align-center xl:text-1xl sm:text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-1"> 
                                ...
                                <span  id="inpt_current_gsph_{{ $row['mc_code'] }}">{{ number_format($row['sph'],0) }}</span>
                            </div>
                        </div> 
                        <div class="text-center text-white-light z-[7]">  
                            <div class="align-center xl:text-1xl sm:text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-1"> 
                                ...
                                <span  id="inpt_average_ct_{{ $row['mc_code'] }}">{{ number_format($row['ct'],0) }}</span>
                            </div>
                        </div> 
                    </div> 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                        <div class="text-center text-white-light z-[7]">  
                            <div class="align-center xl:text-1xl sm:text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-1"> 
                                ...
                                <span  id="inpt_dresser_count_{{ $row['mc_code'] }}">{{ number_format($row['dresser_count'],0) }}</span>
                            </div>
                        </div> 
                        <div class="text-center text-white-light z-[7]">  
                            <div class="align-center xl:text-1xl sm:text-xl shadow-[0_0_2px_0_#bfc9d4] rounded p-1"> 
                                ...
                                <span  id="inpt_spot_count_{{ $row['mc_code'] }}">{{ number_format($row['spot_count'],0) }}</span>
                            </div>
                        </div> 
                    </div> 
        ...
        document.addEventListener("DOMContentLoaded", function() {  
            function setDefaultData(machineId) {  
                ...
                function refeshUi(id) {  
                    ...
                    console.log(responseData + " " + machine_id + " " + topic);
                    if (topic == 'dresser_count') {   
                        ...
                        console.log(qty_plan + " " + qty_actual + " " + current_gsph + " " + bar_progress + " " + average_ct);
