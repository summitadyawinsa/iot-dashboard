        ...
        <div class="pt-5 -mt-5" >
            ...
            <div class="grid lg:grid-cols-6 gap-6 mb-6">
                <div class="panel h-full sm:col-span-6 xl:col-span-2">
                    <div class="flex p-5 border-b  border-[#e0e6ed] dark:border-[#1b2e4b]">
                        <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="https://www.w3.org/2000/svg" class="group-hover:!text-primary shrink-0">
                ...
                <div class="panel h-full sm:col-span-6 xl:col-span-2">
                    <div class="flex p-5 border-b  border-[#e0e6ed] dark:border-[#1b2e4b]">
                        ...
                        <div class="ltr:ml-3 rtl:mr-3 font-semibold">
                            <p class="text-xl dark:text-white-light">JPH Monitoring</p>
            ...
            <div class="grid sm:grid-cols-2 xl:grid-cols-6 gap-6 mb-3">
                ...
                <div class="panel h-full xl:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 pt-5 gap-4  border-t  border-[#e0e6ed] dark:border-[#1b2e4b]">
                        <div class="text-center text-white-light z-[7]">  
            ...
            function setDefaultData(machineId) {  
                    ...
                    axios.get(apiUrl)
                        .then(response => {  
                            ...
                            var dresser_count = data.dresser_count;   
                            var spot_count = data.spot_count;   
                            ...
                            document.getElementById('inpt_dresser_count').textContent = `${dresser_count}`;
                            document.getElementById('inpt_spot_count').textContent = `${spot_count}`;
                ...
                function refeshUi(id) {
                    ...
                    console.log(machine_id + ' Topic : ' + topic + ' ' + responseData.message.dresser_count); 
                    if (machine_id == targetMachineId) { 
                        if (topic == 'dresser_count') {  
                            document.getElementById('inpt_dresser_count').textContent = `${responseData.message.dresser_count}`  ; 
                            document.getElementById('inpt_spot_count').textContent = `${responseData.message.spot_count}`  ; 
                        } else 
                        if (topic == 'set_finish') {  
                            location.reload();
                        } else
        ...
        Alpine.data("analytics", () => ({ 
            ...
            get downtimeChartOptions() {
                    return {
                        ...
                        xaxis: {
                            categories: ['WIP', 'NP', 'RB', 'JB', 'WQ', 'Etc'],
                            axisBorder: {
                                show: true,
                                color: '#3b3f5c' 
                            },
